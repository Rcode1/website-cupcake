...
<body>
	...
	<div class="largura-max-cadastro"
		...
		<div class="borda-cor-cadastro">
			<form action="my_admin_update.jsp" id="main-admin_update"
				method="POST">
				<!------>
					...
					<div class="form-row">
						...
						<div class="form-group col-md-3">
							<label for="adiminDateRegistration_query">Data do
								...
								placeholder="Data: <%=adminRegistrationDao.returnAccess_Administrator_dao().get(0).getAdiminDateRegistration()%>"></input>
						</div>
						...
						<div class="form-group col-md-6">
							<label for="nameAdmin_query">Nome admin *</label> <input
								...
								placeholder="Nome admin: <%=adminRegistrationDao.returnAccess_Administrator_dao().get(0).getNameAdmin()%>"></input>
						</div>
						...
						<div class="form-group col-md-4">
							<label for="accessLevel_query">Nível de acesso *</label> <input
								...
								placeholder="Acesso: <%=adminRegistrationDao.returnAccess_Administrator_dao().get(0).getAccessLevel()%>"></input>
						</div>
						...
						<div class="form-group col-md-8">
							<label for="emailAccess_query">Email *</label> <input
								...
								placeholder="Email: <%=adminRegistrationDao.returnAccess_Administrator_dao().get(0).getEmailAccess()%>"></input>
						</div>
						...
						<div class="form-group col-md-4">
							<label for="adminPassword_query">Senha *</label> <input
								...
								placeholder="Senha:  <%=adminRegistrationDao.returnAccess_Administrator_dao().get(0).getAdminPassword()%>"></input>
						</div>
						...
						<div class="form-group col-md-5">
							<label for="phoneContact_query">Telefone cel * OBS.:
								...
								placeholder="Telefone: <%=adminRegistrationDao.returnAccess_Administrator_dao().get(0).getPhoneContact()%>"></input>
						</div>
