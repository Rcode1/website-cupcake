				...
				<div class="form-row">
					...
					<div class="form-group col-md-4">
						<label for="creationDate_query">Data de criação *</label> <input
							class="form-control" type="date" id="creationDate_query"
					...
					<div class="form-row">
						...
						<div class="form-group col-md-3">
							<label for="productionDate">Data de produção *</label> <input
								class="form-control" type="date" id="productionDate"
								name="fproductionDate" placeholder="D.produção" required></input>
						</div>
						...
						<div class="form-group col-md-3">
							<label for="departureDate">Data de saida</label> <input
								class="form-control" type="date" id="departureDate"
								name="fdepartureDate" placeholder="D.saída"></input>
						</div>
						...
						<div class="form-group col-md-3">
							<label for="productPrice">Valor do produto *</label> <input
								...
								name="fproductPrice" placeholder="V. produto: " required></input>
						</div>

						<div class="form-group col-md-3">
							<label for="productDiscount">Valor do desconto *</label> <input
								class="form-control" type="number" id="productDiscount"
								name="fproductDiscount" placeholder="V. desconto: " required></input>
						</div>
