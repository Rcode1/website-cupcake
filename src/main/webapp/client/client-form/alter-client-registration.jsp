...
<body>
	...
	if (dao_client.clientListResult().get(0).getIdClient()
		...
		Integer a = dao_client.clientListResult().get(0).getIdClient();
		...
		.setName((request.getParameter("fname").isEmpty()) ? dao_client.clientListResult().get(0).getName()
				: request.getParameter("fname"));

		dto_registrationClient.setBirthDate(
		request.getParameter("fbirthDate").isEmpty() ? dao_client.clientListResult().get(0).getBirthDate()
				: request.getParameter("fbirthDate"));

		dto_registrationClient.setDocumentCpf(
		request.getParameter("fdocument").isEmpty() ? dao_client.clientListResult().get(0).getDocumentCpf()
				: request.getParameter("fdocument"));

		dto_registrationClient.setEmailRegistration(
		request.getParameter("femail").isEmpty() ? dao_client.clientListResult().get(0).getEmailRegistration()
				: request.getParameter("femail"));

		dto_registrationClient.setPassword(
		request.getParameter("fpassword").isEmpty() ? dao_client.clientListResult().get(0).getPassword()
				: request.getParameter("fpassword"));

		dto_registrationClient
		.setPhone(request.getParameter("fphone").isEmpty() ? dao_client.clientListResult().get(0).getPhone()
				: request.getParameter("fphone"));

		dto_registrationClient
		.setStreet(request.getParameter("fstreet").isEmpty() ? dao_client.clientListResult().get(0).getStreet()
				: request.getParameter("fstreet"));

		dto_registrationClient.setComplement(
		request.getParameter("fcomplement").isEmpty() ? dao_client.clientListResult().get(0).getComplement()
				: request.getParameter("fcomplement"));

		dto_registrationClient.setHomeNumber(
		request.getParameter("fhomeNumber").isEmpty() ? dao_client.clientListResult().get(0).getHomeNumber()
				: request.getParameter("fhomeNumber"));

		dto_registrationClient.setNeighborhood(request.getParameter("fneighborhood").isEmpty()
		? dao_client.clientListResult().get(0).getNeighborhood()
		: request.getParameter("fneighborhood"));

		dto_registrationClient
		.setCity(request.getParameter("fcity").isEmpty() ? dao_client.clientListResult().get(0).getCity()
				: request.getParameter("fcity"));

		dto_registrationClient
		.setState(request.getParameter("fstate").isEmpty() ? dao_client.clientListResult().get(0).getState()
				: request.getParameter("fstate"));

		dto_registrationClient.setZipCode(
		request.getParameter("fzipCode").isEmpty() ? dao_client.clientListResult().get(0).getZipCode()
