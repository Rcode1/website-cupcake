...
<body>
	...
	<div>
		...
		<div class="  alinhamento-tamanho_max ">
			...
			<div>
				<h3 class="offcanvas-title" id="offcanvasWithBothOptionsLabel">Sobre a empresa</h3>
			</div>
		...
		<div class="  alinhamento-tamanho_max " Style="text-align: center;">
			...
			<div Style="margin-top: 20px;">
				<img Style="max-width: 800px;"
					src="../img/about-us/About_us.jpg
					">

				<div Style="margin-top: 90px;">
					<p><%=generalInformationDao.select_generalInformation_dao().get(0).getAboutUs()%></p>
